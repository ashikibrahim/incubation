...
import  {allApplication,newApplication,pendingApplication,registeredApplication,blockedApplication} from '../features/company/companySlice'
...
function AdminSideBar() {
    ...
    <Box  flex={1} p={3} sx={{display:{xs:'none',lg:'block'}}}>
      ...
      >
        <ListItemButton 
        onClick={()=>dispatch(allApplication())}
         >
          <ListItemIcon>
            <WidgetsIcon/>
          </ListItemIcon>
        ...
        <ListItemButton 
        onClick={()=>dispatch(newApplication())} 
        >
          <ListItemIcon>
            <FiberNewIcon/>
          </ListItemIcon>
        ...
        <ListItemButton 
        onClick={()=>dispatch(pendingApplication())}
        >
          <ListItemIcon>
            <PendingIcon/>
          </ListItemIcon>
        ...
        <ListItemButton 
        onClick={()=>dispatch(registeredApplication())}
        >
          <ListItemIcon>
            <HowToRegIcon/>
          </ListItemIcon>
        ...
        <ListItemButton 
        onClick={()=>dispatch(blockedApplication())}
        >
          <ListItemIcon>
            <NewReleasesIcon/>
          </ListItemIcon>
